...
import tw from 'view-ui-plus/dist/locale/en-US'; //新版本把'iview'改成'view-design'
import pt from 'view-ui-plus/dist/locale/pt-BR'; //新版本把'iview'改成'view-design'
import jp from 'view-ui-plus/dist/locale/ja-JP'; //新版本把'iview'改成'view-design'
...
const messages = {
  ...
  tw: Object.assign(TW, tw), //将自己的中文包和iview提供的结合
  pt: Object.assign(PT, pt), //将自己的中文包和iview提供的结合
  jp: Object.assign(JP, jp), //将自己的中文包和iview提供的结合
};
